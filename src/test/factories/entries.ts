...
export function createTestFoodEntry(
  dogId: string,
  overrides?: { food_name?: string; food_type?: string; amount?: string; meal_time?: string }
) {
...
export function createTestBowelEntry(
  dogId: string,
  overrides?: { consistency?: number; color?: string; occurred_at?: string }
) {
...
export function createTestHealthEntry(
  dogId: string,
  overrides?: { entry_type?: string; severity?: number; occurred_at?: string }
) {
